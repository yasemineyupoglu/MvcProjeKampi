...
namespace BusinessLayer.ValidationRules
{
    public class WriterValidator: AbstractValidator<Writer>
    {
        public WriterValidator()
        {
            ...
            RuleFor(x => x.WriterAbout).NotEmpty().WithMessage("Hakkında kısmını boş geçemezsiniz").Must(x => x.Contains('a')).WithMessage("Hakkında bilgisinde 'a' karakteri geçmek zorundadır.");
